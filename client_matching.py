...
def detect(data_folder,model,seam_detection=True):

    parser = argparse.ArgumentParser('ShapeNetPart Part segmentation training')

    parser.add_argument('--cfg', type=str, required=False,default="./cfgs/shapenetpart/pointnext-s.yaml", help='config file')
...
if __name__  == "__main__":
    ...
    model = 'pointnext'
    seam_detection = True
    detect(None,model,seam_detection=True)
